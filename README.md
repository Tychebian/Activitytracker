...
[![Version](https://img.shields.io/badge/version-v1.0.3-c8320a)](https://github.com/Tychebian/Activitytracker/releases)
...
| 版本 | 说明 |
|------|------|
| v1.0.3 | 活动详情备注（行内编辑）；Markdown 一键导出（可粘贴给 AI 分析） |
